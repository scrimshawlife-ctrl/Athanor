...
| Local SoT | `~/.athanor/corpus/atoms.jsonl` — **3002** high-quality PD atoms (OBSERVED after jev+research classification; junk like secondary Kybalion replaced with primary Dee/Charles/Hermetic Museum etc.; >3000 rows achieved) |
