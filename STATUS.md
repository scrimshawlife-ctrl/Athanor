...
| Local SoT | `~/.athanor/corpus/atoms.jsonl` — **3015** high-quality PD atoms (OBSERVED after jev+research classification; more sources: Kabalah, Arbatel, Grimoire, Ceremonial, Invocation; full Package 4 traceability populated; >3000 rows) |
