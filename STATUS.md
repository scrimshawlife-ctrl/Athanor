...
| Local SoT | `~/.athanor/corpus/atoms.jsonl` — **3065** high-quality PD atoms (OBSERVED after jev+research classification; multiple jev rounds on ALL zero/low families + deeper balance rounds boosting lowest families (many now 2+); jev_classify wired; NO family at 0; full Package 4 core complete; >3000 rows) |
