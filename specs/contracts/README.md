...
Review regression check: `python specs/contracts/verify_review.py` (requires jsonschema). It includes controls against the pre-fix schema and tests both PASS and FAIL paths; it does not certify real gate outcomes.
