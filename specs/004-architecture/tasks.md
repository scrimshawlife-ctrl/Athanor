...
- T4-JEV-004: Add jev usage to doctor output and receipts for harvest provenance. (COMPLETE: doctor now reports jev_harvest; retrieve receipts include jev_harvest note and provenance; AC-JEV-DOCTOR-001, AC-RECEIPT-001 advanced)
