...
FAMILY_SOFT_CAP = 90  # prefer ~40–80; hard balance ≤25% NEW
TARGET_MIN = 40
TARGET_MAX = 80
HOST_FAIL_SKIP = 2
...
HTML_PLAN: list[dict[str, Any]] = [
    {
        ...
        "type": "text",
        "correspondence_kind": "tantra-shakti-historical",
        "urls": [
            f"{MIRROR_HOST}/tantra/sas/sas01.htm",
            f"{MIRROR_HOST}/tantra/sas/sas02.htm",
            f"{MIRROR_HOST}/tantra/sas/sas03.htm",
            f"{MIRROR_HOST}/tantra/sas/sas04.htm",
            f"{MIRROR_HOST}/tantra/sas/sas05.htm",
            f"{MIRROR_HOST}/tantra/sas/sas06.htm",
            f"{MIRROR_HOST}/tantra/sas/sas08.htm",
            f"{MIRROR_HOST}/tantra/sas/sas09.htm",
            f"{MIRROR_HOST}/tantra/sas/sas10.htm",
            f"{MIRROR_HOST}/tantra/htg/htg01.htm",
            f"{MIRROR_HOST}/tantra/htg/htg03.htm",
        ],
        "soft_cap": 22,
        "keywords": TANTRA_KW,
        "dens_min": 0.07,
    },
    {
        ...
        "urls": [f"{MIRROR_HOST}/ich/ic{n:02d}.htm" for n in range(23, 51)],
        "soft_cap": 28,
        "keywords": ICHING_KW,
        "dens_min": 0.05,
    },
    {
        ...
        "urls": [
            f"{MIRROR_HOST}/hin/sbe15/sbe15003.htm",
            f"{MIRROR_HOST}/hin/sbe15/sbe15004.htm",
            f"{MIRROR_HOST}/hin/sbe15/sbe15007.htm",
            f"{MIRROR_HOST}/hin/sbe15/sbe15010.htm",
            f"{MIRROR_HOST}/hin/sbe15/sbe15016.htm",
            f"{MIRROR_HOST}/hin/sbe15/sbe15020.htm",
        ],
        "soft_cap": 16,
        "keywords": VEDA_KW,
        "dens_min": 0.06,
