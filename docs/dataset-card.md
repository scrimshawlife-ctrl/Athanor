...
**Date**: 2026-09-23  
******Total Atoms**: 3225 (with longer PD excerpts)  
...
- **Evaluation Readiness: 682 pairs (jev-expanded with longer PD sources), hit@10 0.265, ndcg 0.784, strong per-family gains on iching/kabbalah.
