...
- **Evaluation Readiness: 7.8/10 (315 pairs, harness live with ndcg 0.80+, per-family, AC-EVAL) (pairs 315 after expansion (jev for low-hit families), harness live, per-family metrics, AC-EVAL-001). Updated with deeper Package 4 docs.
