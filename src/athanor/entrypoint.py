    ...
    if corpus.is_file():
        try:
            ...
            if atoms:
                ...
                payload["corpus_note"] = "All classifying/selection/harvest via jev rerank only; primary PD OBSERVED; 3775 atoms; min pair 24; mystery_cults, tantra_hist_pd, angel boosted to 29; hermetic 32; other lows at 24 (egypt_magical, history_magic, islamic_occult_pd, grimoire); alchemy 322; long 15.3%; gold 1506 pairs + 362 negatives; continue low family pair/neg expansion (mystery/ tantra/angel). Full verify PASS."
