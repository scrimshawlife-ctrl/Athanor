    ...
    if corpus.is_file():
        try:
            ...
            if atoms:
                ...
                payload["corpus_note"] = "All classifying/selection/harvest via jev rerank only; primary PD OBSERVED; 3775 atoms; min pair 25; egypt_magical, history_magic, islamic_occult_pd, grimoire boosted to 32; mystery_cults/tantra/angel 29, hermetic 32; alchemy 322; long 15.3%; gold 1538 pairs + 367 negatives; 24s boost (egypt/history note: short atoms, pair count lift). Full verify PASS."
