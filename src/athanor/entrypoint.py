    ...
    if corpus.is_file():
        try:
            ...
            if atoms:
                ...
                payload["corpus_note"] = "All classifying/selection/harvest via jev rerank only; primary PD OBSERVED; 3775 atoms; min pair 29; folk_magic_pd 33, solomonic 34, enochian 34, neoplatonism 34; previous lows boosted; alchemy 322; long 15.3%; gold 1654 pairs + 382 negatives; 27s boost (solomonic source attempt jev 0). Full verify PASS."
