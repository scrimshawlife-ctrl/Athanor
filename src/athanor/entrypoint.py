    ...
    if corpus.is_file():
        try:
            ...
            if atoms:
                ...
                payload["corpus_note"] = "All classifying/selection/harvest via jev rerank only; primary PD OBSERVED; 3775 atoms; min pair 13; low families 7 near-min (meso 13+); alchemy 322; shinto 16; long 15.3%; gold 1324 pairs + 302 negatives; harness Option 3: dynamic low threshold + low ndcg avg, expanded samples to 10 + low 5; TDD tests. Full verify PASS."
