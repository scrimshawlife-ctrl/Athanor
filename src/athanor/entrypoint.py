    ...
    if corpus.is_file():
        try:
            ...
            if atoms:
                ...
                payload["corpus_note"] = "All classifying/selection/harvest via jev rerank only; primary PD OBSERVED; 3655 atoms; min pair 9; 0 low; alchemy 290; long 12.5%; gold 1204 pairs + 172 negatives; extended quality + per-family ndcg in doctor/harness"
