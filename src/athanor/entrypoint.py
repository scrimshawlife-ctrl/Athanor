    ...
    if corpus.is_file():
        try:
            ...
            if atoms:
                ...
                payload["corpus_note"] = "All classifying/selection/harvest via jev rerank only; primary PD OBSERVED; 3775 atoms; min pair 13; low families 7 near-min (meso 13+); alchemy 322; shinto 16; long 15.3%; gold 1324 pairs + 282 negatives; harness tweaks active + proper NDCG; gold expansion round with quality hold (jev 0 on new low family sources). Full verify PASS."
