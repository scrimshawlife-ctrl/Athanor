    ...
    if corpus.is_file():
        try:
            ...
            if atoms:
                ...
                payload["corpus_note"] = "All classifying/selection/harvest via jev rerank only; primary PD OBSERVED; 3645 atoms; min pair 8; 0 low; alchemy 290; long 12.3%; gold 1194 pairs + 162 negatives; extended quality + per-family ndcg in doctor/harness"
